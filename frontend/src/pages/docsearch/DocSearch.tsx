        ...
        <div className={styles.container}>
            ...
            <div className={styles.chatRoot}>
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>ドキュメントを検索</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>なんでも聞いてください。または以下から試してみてください。</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="ChatGPTがドキュメントの検索をお手伝いします。何について知りたいですか？"
                            disabled={isLoading}
                ...
                >
                    ...
                    />
                    <TextField className={styles.chatSettingsSeparator} label="除外設定（例：カテゴリー、単語など）" onChange={onExcludeCategoryChanged} />
                    <Checkbox
                        className={styles.chatSettingsSeparator}
                        checked={useSemanticRanker}
                        label="単語一致のみでなく、質問の意図を汲み取って回答する"
                        onChange={onUseSemanticRankerChange}
                    />
                    <Checkbox
                        className={styles.chatSettingsSeparator}
                        checked={useSemanticCaptions}
                        label="関連するドキュメントを要約して回答する"
